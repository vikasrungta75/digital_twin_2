/**
 * PageHeader — shared branded header block for all Digital Twin dashboards.
 *
 * Usage:
 *   import PageHeader from './PageHeader';
 *   <PageHeader iconPath={ICON_PATHS.overview} title="Vehicle Overview" subtitle="…" />
 */
import React from 'react';

// ─── Canonical icon paths (material design SVG d= strings) ───────────────────
export const ICON_PATHS = {
  ...
  agentRec:     'M11.5 2C6.81 2 3 5.81 3 10.5S6.81 19 11.5 19h.5v3c4.86-2.34 8-7 8-11.5C20 5.81 16.19 2 11.5 2zm1 14.5h-2v-2h2v2zm0-4h-2c0-3.25 3-3 3-5 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4 1.79 4 4c0 2.5-3 2.75-3 5z',
  ...
  convIntel:    'M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z',
};
...
interface PageHeaderProps {
  ...
  title: string;
  subtitle: string;
  /** Optional accent colour — defaults to Ravity pink */
  accent?: string;
}
