...
const parseSections = (text: string): AnalysisSection[] => {
  ...
  if (sections.length === 0)
    sections.push({ title: 'AI Analysis', icon: '🤖', content: text, severity: 'info' });
  return sections;
};
...
const AiAnalysisDashboard: FC = () => {
  ...
  return (
    <div style={page} id="dt-page-content">
      ...
      <h1 style={{ color: '#e91e8c', fontWeight: 900, fontSize: 26, marginBottom: 20 }}>🤖 AI Vehicle Analysis</h1>
