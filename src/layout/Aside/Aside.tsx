    ...
    return (
        <>
            <style>{`
                ...
                .wrapper { padding-left: ${w}px !important; transition: padding-left 0.22s cubic-bezier(.4,0,.2,1) !important; }
                .wrapper-RTL { padding-right: ${w}px !important; transition: padding-right 0.22s cubic-bezier(.4,0,.2,1) !important; }
                ...
                .dt-section-label { transition: opacity 0.15s, max-height 0.22s; max-height: 40px; overflow: hidden; }
                .dt-aside.collapsed .dt-section-label { opacity: 0; max-height: 0; padding: 0 !important; }
                .dt-toggle {
                ...
                .dt-toggle:hover { background: rgba(255,255,255,0.20); color: #fff; }
            `}</style>

            <aside className={classNames('dt-aside', { collapsed })} style={{ width: w }}>
                ...
                <div style={{
                    ...
                    {/* Toggle button */}
                    <button className='dt-toggle' onClick={toggle}
            ...
            {mobileDesign && asideStatus && (
                <div role='presentation' onClick={() => setAsideStatus(false)}
                    style={{ position:'fixed', inset:0, zIndex:1034, background:'rgba(0,0,0,0.4)' }}
                />
            )}
        </>
    );
