...
const SvgLeaderboard = (props: SVGProps<SVGSVGElement>) => {
	return (
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" {...props}>
			<path d="M7.33333 1.33334C3.28333 1.33334 0 4.61668 0 8.66668C0 12.7167 3.28333 16 7.33333 16C11.3833 16 14.6667 12.7167 14.6667 8.66668H7.33333V1.33334Z" fill="white" />
			<path d="M8.66666 0V7.33333H16C16 3.28333 12.7167 0 8.66666 0Z" fill="white" />
		</svg>
	);
}
